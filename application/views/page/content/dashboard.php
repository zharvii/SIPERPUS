<?php
$query1 = $this->db->query("select * from siswa");
$query2 = $this->db->query("select * from buku");
$siswa = $query1->num_rows();
$buku = $query2->num_rows();
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Home
            <small>Perpustakaan SMK KRIAN 1</small>
        </h1>
        <ol class="breadcrumb">
