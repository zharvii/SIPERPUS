    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <button type="button" data-toggle="modal" data-target="#modal-tmb" class="btn btn-info btn-xl pull-left">Tambah Siswa</button>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jk" id="jk">
                            <option id="ada" value="Laki-Laki">Laki-Laki</option>
                            <option id="dipinjam" value="Perempuan">Perempuan</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
...
<script>
    ...
    $(function() {
        ...
        var table = $("#mytable").dataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo base_url() . 'siswa/get_guest_json' ?>",
                "type": "POST"
            },
            columns: [{
                    "data": "nisn"
