...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <button type="button" data-toggle="modal" data-target="#modal-tmb" class="btn btn-info btn-xl pull-left">Tambah Buku</button>
            ...
            <form id="frmEdit">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>ID Buku</label>
                        <input type="text" readonly class="form-control" id="idbuku" name="idbuku">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" style="padding-right:7px;" class="btn btn-danger btn-xl" data-dismiss="modal">Close</button>
                        <button type="button" id="btnEdit" class="btn btn-info btn-xl" data-dismiss="modal">Edit</button>
                    </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $(function() {
        ...
        $('#mytable').on('click', '.hapus', function() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>buku/hapusBuku",
                method: "POST",
                dataType: 'json',
                data: {
                    id: id
        ...
        $('#btnEdit').click(function() {
            $.ajax({
                url: "<?php echo base_url(); ?>buku/editBuku",
                method: "POST",
                dataType: 'text',
        ...
        $('#btnTmb').click(function() {
            $.ajax({
                url: "<?php echo base_url(); ?>buku/insertBuku",
                method: "POST",
                dataType: 'text',
                data: $('#frmTmb').serialize(),
                success: function(data) {
                    if (data == '1') {
                        $('#mytable').DataTable().ajax.reload();
                    }
